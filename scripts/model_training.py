...
class WGAN(object):
    ...
    def train(self, config):
        ...
        if self.load(self.checkpoint_dir):
            print(" [*] Load SUCCESS, continuing training")
        else:
            print(" [!] Load failed, training from scratch...")
        ...
        for epoch in xrange(config.epoch):
            ...
            print(' --- Epoch '+str(epoch)+', using '+str(len(water_data))+' water images, '+str(len(air_data))+' RGB images, '+str(len(depth_data))+' depth images')
